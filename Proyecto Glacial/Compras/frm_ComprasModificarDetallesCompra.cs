    ...
    public partial class frm_ComprasModificarDetallesCompra : Form
    {
        ...
        private void btn_actualizar_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < lista_material_comprasDataGridView.Rows.Count - 1; i++)//Ciclo para agregar la Lista
            {
                ...
                cantidad2 = Convert.ToInt32(lista_material_comprasDataGridView.Rows[i].Cells[4].Value);
                unidad_medida = lista_material_comprasDataGridView.Rows[i].Cells[3].Value.ToString();
                ...
                precioUnitario2 = Convert.ToDouble(lista_material_comprasDataGridView.Rows[i].Cells[5].Value);
                Program.idListaCompra = Convert.ToInt32(lista_material_comprasDataGridView.Rows[i].Cells[0].Value);
                this.lista_material_comprasTableAdapter.UpdateDetallesProducto(Program.idCompra, total2, cantidad2, idProducto2, unidad_medida, nombre,precioUnitario2,Program.idListaCompra);
            }
