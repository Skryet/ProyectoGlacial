...
namespace Proyecto_Glacial
{
    ...
    {
        private static MySqlConnection conexion = new MySqlConnection("server=192.168.1.83;user id=SGAglacial;password=pato12;persistsecurityinfo=True;database=glacial_almacen");
