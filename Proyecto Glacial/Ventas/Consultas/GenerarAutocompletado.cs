...
namespace Proyecto_Glacial.Ventas.Consultas
{
    class GenerarAutocompletado
    {
        ...
        public void llenarListaAutocompletarCodigo(string buscarCodigo, Objetos.ListaEnlazadaProductos listaProductos, bool mostrarTodo)
        {
        ...
        public void llenarListaAutocompletarDescripcion(string buscarDescripcion, Objetos.ListaEnlazadaProductos listaProductos, bool mostrarTodo)
        {
            string comando = "SELECT id_producto, id_linea_producto, nombre, descripcion, existencia, unidad_medida, precio1, precio2, precio3, precio_especial"
        ...
        public void llenarListaAutocompletarNombre(string buscarNombre, Objetos.ListaEnlazadaProductos listaProductos, bool mostrarTodo)
        {
            string comando = "SELECT id_producto, id_linea_producto, nombre, descripcion, existencia, unidad_medida, precio1, precio2, precio3, precio_especial"
                + " FROM productos WHERE nombre LIKE '%" + buscarNombre + "%';";
            MySqlCommand consulta = new MySqlCommand(comando, generarConexion.obtenerConexion);
            conexion.abrirConexion();
            try
            {
